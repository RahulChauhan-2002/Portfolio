...
const ResumeCard = ({title,subTitle,result,des}) => {
  return (
    <div className='w-full h-1/3 group flex'>
        ...
        <div className='w-full bg-[rgba(0,0,0,0.2)] hover:bg-[rgba(0,0,0,0.3)] duration-300 rounded-lg px-10 flex flex-col justify-center gap-10 customBox'>
            <div className='flex justify-between items-center'>
                ...
                <div>
                    <p className='w-20 h-10 text-[#ff014f] bg-[rgba(0,0,0,0.25)] rounded-lg flex justify-center items-center customBox text-sm font-medium '>{result}</p>
                </div>
            </div>
