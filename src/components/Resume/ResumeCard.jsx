    ...
    <div className='w-full h-1/3 group flex'>
        ...
        <div className='w-full bg-[rgba(0,0,0,0.2)] hover:bg-[rgba(0,0,0,0.3)] duration-300 rounded-lg px-10 flex flex-col justify-center gap-10 [box-shadow:7px_9px_18px_#1c1022,_-7px_-9px_19px_#262a2e]'>
            <div className='flex justify-between items-center'>
                ...
                <div>
                    <p className='w-20 h-10 text-[#ff014f] bg-[rgba(0,0,0,0.25)] rounded-lg flex justify-center items-center [box-shadow:7px_9px_18px_#1c1022,_-7px_-9px_19px_#262a2e] text-sm font-medium '>{result}</p>
                </div>
            </div>
